...
<div class="">
    <div class="container mx-auto mt-[440px]">
        <div>
            <h2 class="text-4xl pt-4 text-center">Cảm ơn quý khách đã đặt hàng</h2>
            ...
            ?>
            <div class="font-medium text-center text-lg mt-3">Thông tin đơn hàng</div>
            <table class="mx-auto ">
                <tr>
                    <td>Mã đơn hàng: SP-<?= $bill['id_bill'] ?></td>
                </tr>
                <tr>
                    <td>Ngày đặt hàng: SP-<?= $bill['order_date']; ?></td>
                </tr>
                <tr>
                    <td>Tổng đơn hàng: <?= $bill['total']; ?></td>
                </tr>
                <tr>
                    <td>Phương thức thanh toán: <?= $bill['bill_pttt']; ?></td>
                </tr>
            </table>
        </div>
        <div>
            <div class="font-medium text-center text-lg mt-3">Thông tin đặt hàng</div>
            <div>
    ...
    <div>
        <div class="font-medium text-center text-lg mt-3">Chi tiết giỏi hàng</div>
        <div>
            <table class="mx-auto mt-3">
