...
<div class="container mx-auto mt-[450px]">
    ...
    <form class="border mx-auto w-[70%]" action="index.php?act=billcomfirm" method="post">

        <h2 class="text-4xl pt-4 text-center">Thông tin đặt hàng</h2>
        ...
        <div class="mx-auto">
            <div class="text-center text-lg mt-3 font-medium">Phương thức thanh toán</div>
            <div>
                <table class="mx-auto mt-2">
                    <tr>
                        <td><input class="" type="radio" name="pttt" id="" value="1" checked>Trả tiền khi nhận hàng</td>
                        <td class="px-3"><input class="" type="radio" name="pttt" value="2" id="">Chuyển khoản ngân hàng</td>
        ...
        <div>
            <div class="text-center text-lg mt-3 font-medium">Thông tin giỏ</div>
            <div>
        ...
        <div class="text-center">
            <input class="border bg-blue-500 text-white px-2 py-1 rounded-md hover:-translate-y-1 hover:scale-110 mt-2" type="submit" value="Đặt hàng" name="dongydathang">
        </div>
    </form>
    <script>
