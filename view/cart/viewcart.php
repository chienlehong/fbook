            ...
            <div class="flex">
                ...
                ?>
                    ...
                    <div class=" flex">
                        ...
                        <!-- đơn hàng -->
                        <div class="">
                            <a href="index.php?act=bill"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
<div class="">
    ...
    <a href="#">
        <p class="absolute text-gray-500 bg-gray-200 top-[28%] left-0 opacity-50 hover:opacity-80 h-[55px] text-5xl " onclick="h2()">
            < </p>
    </a>
    <a href="#">
        <p class="absolute text-gray-500 bg-gray-200 top-[28%] right-0 opacity-50 hover:opacity-80 h-[55px] text-5xl" onclick="h1()">></p>
    </a>
</div>
<!-- nav -->
...
<div class="">
    <div class="container mx-auto mt-[450px]">
        <div>
            <h2 class="text-4xl pt-4 text-center">Giỏ hàng</h2>

            <hr class="pb-5">
            <table class="w-[70%] mx-auto text-center">
                <?php
                viewcart(1);
                ?>
            </table>
            <div class="text-center mt-10"><a href="index.php?act=bill"><input class="border bg-blue-500 text-white px-2 py-1 rounded-md hover:-translate-y-1 hover:scale-110" type="button" value="Tiếp tục đặt hàng"></a>
                <a onclick="return deleteOnclick(' tất cả ')" href="index.php?act=delcart"><input class="border bg-red-500 text-black px-2 py-1 rounded-md hover:-translate-y-1 hover:scale-110" type="button" value="Xóa giỏ hàng"></a>
                <a href="index.php?act=mybill"><input class="border bg-blue-500 text-white px-2 py-1 rounded-md hover:-translate-y-1 hover:scale-110" type="button" value="Đơn hàng của bạn"></a>
            </div>
        </div>
    </div>
