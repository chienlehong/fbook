...
<div id="id02" class="mt-[400px]">

    <form class="modal-content" action="index.php?act=dangky" method="post">
        <div class="container">
            <h2 class="text-4xl pt-4">Sign Up</h2>
            <p class="pb-2">Please fill in this form to create an account.</p>
            <hr class="pb-5">
            <label for="email"><b>Email</b></label>
            <input class="c" type="email" placeholder="Enter Email" name="email" >
            <span><?php echo (isset($err['email']))?$err['email']:''?></span>
            <label for="user"><b>Username</b></label>
            <input class="c" type="text" placeholder="Enter Username" name="user" required>

            <label for="psw"><b>Password</b></label>
            <input class="c" type="password" placeholder="Enter Password" name="pass" required>

            <label for="psw-repeat"><b>Repeat Password</b></label>
            <input class="c" type="password" placeholder="Repeat Password" name="pass-repeat" required>
            ...
            <div class="clearfix grid grid-cols-2 gap-6  ">
                ...
                <input type="submit" class="border bg-green-600 text-white hover:bg-blue-600" value="Sign Up" name="dangky">
            </div>
